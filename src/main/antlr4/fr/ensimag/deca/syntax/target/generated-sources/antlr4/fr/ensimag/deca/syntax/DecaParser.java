...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		PRINT=12, EXTENDS=3, INSTANCEOF=7, NEW=8, LT=22, CLASS=2, MINUS=26, ELSE=4, 
		INCLUDE=49, IF=6, NULL=9, DOT=30, TRUE=19, CBRACE=35, GEQ=40, OBRACE=34, 
		AND=42, THIS=18, SEPARATEUR=48, EXCLAM=36, PLUS=25, PRINTX=15, FLOAT=45, 
		PRINTLN=13, READINT=10, PRINTLNX=14, SEMI=37, INT=44, RETURN=17, CPARENT=33, 
		ASM=1, PROTECTED=16, COMMA=31, OR=43, EQUALS=24, TIMES=27, MULTI_LINE_STRING=47, 
		SLASH=28, GT=23, OPARENT=32, IDENT=21, PERCENT=29, EQEQ=38, LEQ=41, STRING=46, 
		FALSE=5, WHILE=20, NEQ=39, READFLOAT=11;
	public static final String[] tokenNames = {
		"<INVALID>", "'asm'", "'class'", "'extends'", "'else'", "'false'", "'if'", 
		"'instanceof'", "'new'", "'null'", "'readInt'", "'readFloat'", "'print'", 
		"'println'", "'printlnx'", "'printx'", "'protected'", "'return'", "'this'", 
		"'true'", "'while'", "IDENT", "'<'", "'>'", "'='", "'+'", "'-'", "'*'", 
		"'/'", "'%'", "'.'", "','", "'('", "')'", "'{'", "'}'", "'!'", "';'", 
		"'=='", "'!='", "'>='", "'<='", "'&&'", "'||'", "INT", "FLOAT", "STRING", 
		"MULTI_LINE_STRING", "SEPARATEUR", "INCLUDE"
	};
	public static final int
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			{
			setState(74); ((ProgContext)_localctx).list_classes = list_classes();
			setState(75); ((ProgContext)_localctx).main = main();
	...
	public final MainContext main() throws RecognitionException {
		...
		try {
			...
			case OBRACE:
				...
				{
				setState(80); ((MainContext)_localctx).block = block();
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(85); match(OBRACE);
			setState(86); ((BlockContext)_localctx).list_decl = list_decl();
			setState(87); ((BlockContext)_localctx).list_inst = list_inst();
			setState(88); match(CBRACE);
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(91); decl_var_set(_localctx.tree);
					}
					} 
				}
				setState(96);
	...
	public final Decl_var_setContext decl_var_set(ListDeclVar l) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(97); ((Decl_var_setContext)_localctx).type = type();
			setState(98); list_decl_var(_localctx.l,((Decl_var_setContext)_localctx).type.tree);
	...
	public final List_decl_varContext list_decl_var(ListDeclVar l,AbstractIdentifier t) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(101); ((List_decl_varContext)_localctx).dv1 = decl_var(_localctx.t);
			...
			while (_la==COMMA) {
				...
				setState(104); ((List_decl_varContext)_localctx).dv2 = decl_var(_localctx.t);
	...
	public final Decl_varContext decl_var(AbstractIdentifier t) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(112); ((Decl_varContext)_localctx).i = ident();
			...
			if (_la==EQUALS) {
				{
				setState(114); ((Decl_varContext)_localctx).EQUALS = match(EQUALS);
				setState(115); ((Decl_varContext)_localctx).e = expr();
	...
	public final List_instContext list_inst() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << FALSE) | (1L << IF) | (1L << NEW) | (1L << NULL) | (1L << READINT) | (1L << READFLOAT) | (1L << PRINT) | (1L << PRINTLN) | (1L << PRINTLNX) | (1L << PRINTX) | (1L << RETURN) | (1L << THIS) | (1L << TRUE) | (1L << WHILE) | (1L << IDENT) | (1L << MINUS) | (1L << OPARENT) | (1L << EXCLAM) | (1L << SEMI) | (1L << INT) | (1L << FLOAT) | (1L << STRING))) != 0)) {
				{
				{
				setState(122); ((List_instContext)_localctx).e = inst();

				    	_localctx.tree.add(((List_instContext)_localctx).e.tree);
				    	setLocation(_localctx.tree, (((List_instContext)_localctx).e!=null?(((List_instContext)_localctx).e.start):null));
	...
	public final InstContext inst() throws RecognitionException {
		...
		try {
			...
			case STRING:
				enterOuterAlt(_localctx, 1);
				{
				setState(130); ((InstContext)_localctx).e1 = expr();
			...
			case SEMI:
				enterOuterAlt(_localctx, 2);
				{
				setState(134); ((InstContext)_localctx).SEMI = match(SEMI);
			...
			case PRINT:
				...
				setState(137); match(OPARENT);
				setState(138); ((InstContext)_localctx).list_expr = list_expr();
				setState(139); match(CPARENT);
			...
			case PRINTLN:
				...
				{
				setState(143); match(PRINTLN);
				setState(144); match(OPARENT);
				setState(145); ((InstContext)_localctx).list_expr = list_expr();
				setState(146); match(CPARENT);
			...
			case PRINTX:
				...
				{
				setState(150); match(PRINTX);
				setState(151); match(OPARENT);
				setState(152); ((InstContext)_localctx).list_expr = list_expr();
				setState(153); match(CPARENT);
			...
			case PRINTLNX:
				...
				{
				setState(157); match(PRINTLNX);
				setState(158); match(OPARENT);
				setState(159); ((InstContext)_localctx).list_expr = list_expr();
				setState(160); match(CPARENT);
			...
			case IF:
				...
				{
				setState(164); ((InstContext)_localctx).if_then_else = if_then_else();
			...
			case WHILE:
				...
				setState(168); match(OPARENT);
				setState(169); ((InstContext)_localctx).condition = expr();
				setState(170); match(CPARENT);
				setState(171); match(OBRACE);
				setState(172); ((InstContext)_localctx).body = list_inst();
				setState(173); match(CBRACE);
			...
			case RETURN:
				...
				setState(177); ((InstContext)_localctx).expr = expr();
	...
	public final If_then_elseContext if_then_else() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(183); ((If_then_elseContext)_localctx).if1 = match(IF);
			setState(184); match(OPARENT);
			setState(185); ((If_then_elseContext)_localctx).condition = expr();
			setState(186); match(CPARENT);
			setState(187); match(OBRACE);
			setState(188); ((If_then_elseContext)_localctx).li_if = list_inst();
			setState(189); match(CBRACE);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(192); ((If_then_elseContext)_localctx).elsif = match(IF);
					setState(193); match(OPARENT);
					setState(194); ((If_then_elseContext)_localctx).elsif_cond = expr();
					setState(195); match(CPARENT);
					setState(196); match(OBRACE);
					setState(197); ((If_then_elseContext)_localctx).elsif_li = list_inst();
					setState(198); match(CBRACE);

					      		t2 = new IfThenElse(((If_then_elseContext)_localctx).elsif_cond.tree, ((If_then_elseContext)_localctx).elsif_li.tree, new ListInst());
			...
			if (_la==ELSE) {
				...
				setState(208); ((If_then_elseContext)_localctx).li_else = list_inst();
				setState(209); match(CBRACE);

				      		tTete.setElseBranch(((If_then_elseContext)_localctx).li_else.tree);
	...
	public final List_exprContext list_expr() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << FALSE) | (1L << NEW) | (1L << NULL) | (1L << READINT) | (1L << READFLOAT) | (1L << THIS) | (1L << TRUE) | (1L << IDENT) | (1L << MINUS) | (1L << OPARENT) | (1L << EXCLAM) | (1L << INT) | (1L << FLOAT) | (1L << STRING))) != 0)) {
				{
				setState(214); ((List_exprContext)_localctx).e1 = expr();
				...
				while (_la==COMMA) {
					...
					setState(217); ((List_exprContext)_localctx).e2 = expr();
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(227); ((ExprContext)_localctx).assign_expr = assign_expr();
	...
	public final Assign_exprContext assign_expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(230); ((Assign_exprContext)_localctx).e = or_expr(0);
			setState(237);
			switch (_input.LA(1)) {
			case EQUALS:
				{
				...
				setState(233); ((Assign_exprContext)_localctx).e2 = assign_expr();
	...
	private Or_exprContext or_expr(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(240); ((Or_exprContext)_localctx).e = and_expr(0);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(245); ((Or_exprContext)_localctx).e2 = and_expr(0);
	...
	private And_exprContext and_expr(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(254); ((And_exprContext)_localctx).e = eq_neq_expr(0);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(259); ((And_exprContext)_localctx).e2 = eq_neq_expr(0);
	...
	private Eq_neq_exprContext eq_neq_expr(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(268); ((Eq_neq_exprContext)_localctx).e = inequality_expr(0);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(272); match(EQEQ);
						setState(273); ((Eq_neq_exprContext)_localctx).e2 = inequality_expr(0);
					...
					case 2:
						...
						setState(276);
						if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
						setState(277); match(NEQ);
						setState(278); ((Eq_neq_exprContext)_localctx).e2 = inequality_expr(0);
	...
	private Inequality_exprContext inequality_expr(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(287); ((Inequality_exprContext)_localctx).e = sum_expr(0);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(291); match(LEQ);
						setState(292); ((Inequality_exprContext)_localctx).e2 = sum_expr(0);
					...
					case 2:
						...
						setState(296); match(GEQ);
						setState(297); ((Inequality_exprContext)_localctx).e2 = sum_expr(0);
					...
					case 3:
						...
						setState(302); ((Inequality_exprContext)_localctx).e2 = sum_expr(0);
					...
					case 4:
						...
						setState(307); ((Inequality_exprContext)_localctx).e2 = sum_expr(0);
					...
					case 5:
						...
						setState(310);
						if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
						setState(311); match(INSTANCEOF);
						setState(312); ((Inequality_exprContext)_localctx).type = type();
	...
	private Sum_exprContext sum_expr(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(321); ((Sum_exprContext)_localctx).e = mult_expr(0);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(324);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(325); match(PLUS);
						setState(326); ((Sum_exprContext)_localctx).e2 = mult_expr(0);
					...
					case 2:
						...
						setState(331); ((Sum_exprContext)_localctx).e2 = mult_expr(0);
	...
	private Mult_exprContext mult_expr(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(340); ((Mult_exprContext)_localctx).e = unary_expr();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(343);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(344); match(TIMES);
						setState(345); ((Mult_exprContext)_localctx).e2 = unary_expr();
					...
					case 2:
						...
						setState(348);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(349); match(SLASH);
						setState(350); ((Mult_exprContext)_localctx).e2 = unary_expr();
					...
					case 3:
						...
						setState(353);
						if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
						setState(354); match(PERCENT);
						setState(355); ((Mult_exprContext)_localctx).e2 = unary_expr();
	...
	public final Unary_exprContext unary_expr() throws RecognitionException {
		...
		try {
			...
			case MINUS:
				enterOuterAlt(_localctx, 1);
				{
				setState(363); ((Unary_exprContext)_localctx).op = match(MINUS);
				setState(364); ((Unary_exprContext)_localctx).e = unary_expr();
			...
			case EXCLAM:
				enterOuterAlt(_localctx, 2);
				{
				setState(367); ((Unary_exprContext)_localctx).op = match(EXCLAM);
				setState(368); ((Unary_exprContext)_localctx).e = unary_expr();
			...
			case STRING:
				enterOuterAlt(_localctx, 3);
				{
				setState(371); ((Unary_exprContext)_localctx).select_expr = select_expr(0);
	...
	private Select_exprContext select_expr(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(377); ((Select_exprContext)_localctx).e = primary_expr();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(380);
					if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
					setState(381); match(DOT);
					setState(382); ((Select_exprContext)_localctx).i = ident();
					...
					case 1:
						{
						setState(384); ((Select_exprContext)_localctx).o = match(OPARENT);
						setState(385); ((Select_exprContext)_localctx).args = list_expr();
						setState(386); match(CPARENT);
	...
	public final Primary_exprContext primary_expr() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(397); ((Primary_exprContext)_localctx).ident = ident();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(400); ((Primary_exprContext)_localctx).m = ident();
				setState(401); match(OPARENT);
				setState(402); ((Primary_exprContext)_localctx).args = list_expr();
				setState(403); match(CPARENT);
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(406); match(OPARENT);
				setState(407); ((Primary_exprContext)_localctx).expr = expr();
				setState(408); match(CPARENT);
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(411); ((Primary_exprContext)_localctx).READINT = match(READINT);
				setState(412); match(OPARENT);
				setState(413); match(CPARENT);
			...
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(415); ((Primary_exprContext)_localctx).READFLOAT = match(READFLOAT);
				setState(416); match(OPARENT);
				setState(417); match(CPARENT);
			...
			case 6:
				...
				setState(420); ((Primary_exprContext)_localctx).ident = ident();
				setState(421); match(OPARENT);
				setState(422); match(CPARENT);
			...
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(425); ((Primary_exprContext)_localctx).cast = match(OPARENT);
				setState(426); ((Primary_exprContext)_localctx).type = type();
				setState(427); match(CPARENT);
				setState(428); match(OPARENT);
				setState(429); ((Primary_exprContext)_localctx).expr = expr();
				setState(430); match(CPARENT);
			...
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(433); ((Primary_exprContext)_localctx).literal = literal();
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(438); ((TypeContext)_localctx).ident = ident();
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			case INT:
				enterOuterAlt(_localctx, 1);
				{
				setState(441); ((LiteralContext)_localctx).INT = match(INT);
			...
			case FLOAT:
				enterOuterAlt(_localctx, 2);
				{
				setState(443); ((LiteralContext)_localctx).fd = match(FLOAT);
			...
			case STRING:
				enterOuterAlt(_localctx, 3);
				{
				setState(445); ((LiteralContext)_localctx).STRING = match(STRING);
			...
			case TRUE:
				enterOuterAlt(_localctx, 4);
				{
				setState(447); ((LiteralContext)_localctx).TRUE = match(TRUE);
			...
			case FALSE:
				enterOuterAlt(_localctx, 5);
				{
				setState(449); ((LiteralContext)_localctx).FALSE = match(FALSE);
	...
	public final IdentContext ident() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(457); ((IdentContext)_localctx).i = match(IDENT);

			    		((IdentContext)_localctx).tree =  new Identifier(sTable.create(((IdentContext)_localctx).i.getText()));
	...
	public final List_classesContext list_classes() throws RecognitionException {
		...
		try {
			...
			while (_la==CLASS) {
				{
				{
				setState(460); ((List_classesContext)_localctx).c1 = class_decl();

				      		/*_localctx.tree.add(c1);*/
	...
	public final Class_declContext class_decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(468); match(CLASS);
			setState(469); ((Class_declContext)_localctx).name = ident();
			setState(470); ((Class_declContext)_localctx).superclass = class_extension();
			setState(471); match(OBRACE);
			setState(472); class_body();
			setState(473); match(CBRACE);
	...
	public final Class_extensionContext class_extension() throws RecognitionException {
		...
		try {
			...
			case EXTENDS:
				enterOuterAlt(_localctx, 1);
				{
				setState(476); ((Class_extensionContext)_localctx).EXTENDS = match(EXTENDS);
				setState(477); ((Class_extensionContext)_localctx).ident = ident();
	...
	public final Class_bodyContext class_body() throws RecognitionException {
		...
		try {
			...
			while (_la==PROTECTED || _la==IDENT) {
				...
				case 1:
					{
					setState(483); ((Class_bodyContext)_localctx).m = decl_method();
	...
	public final Decl_field_setContext decl_field_set() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(492); ((Decl_field_setContext)_localctx).v = visibility();
			setState(493); ((Decl_field_setContext)_localctx).t = type();
			setState(494); list_decl_field();
	...
	public final List_decl_fieldContext list_decl_field() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(502); ((List_decl_fieldContext)_localctx).dv1 = decl_field();
			setState(507);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(504); ((List_decl_fieldContext)_localctx).dv2 = decl_field();
				}
				}
				setState(509);
				_errHandler.sync(this);
	...
	public final Decl_fieldContext decl_field() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(510); ((Decl_fieldContext)_localctx).i = ident();
			...
			if (_la==EQUALS) {
				...
				setState(513); ((Decl_fieldContext)_localctx).e = expr();
	...
	public final Decl_methodContext decl_method() throws RecognitionException {
		...
		try {
			...
			setState(520); type();
			setState(521); ident();
			setState(522); match(OPARENT);
			setState(523); ((Decl_methodContext)_localctx).params = list_params();
			setState(524); match(CPARENT);
			setState(535);
			switch (_input.LA(1)) {
			case OBRACE:
				{
			...
			case ASM:
				{
				setState(528); match(ASM);
				setState(529); match(OPARENT);
				setState(530); ((Decl_methodContext)_localctx).code = multi_line_string();
				setState(531); match(CPARENT);
	...
	public final List_paramsContext list_params() throws RecognitionException {
		...
		try {
			...
			if (_la==IDENT) {
				{
				setState(539); ((List_paramsContext)_localctx).p1 = param();
				...
				while (_la==COMMA) {
					...
					setState(542); ((List_paramsContext)_localctx).p2 = param();
	...
	public final Multi_line_stringContext multi_line_string() throws RecognitionException {
		...
		try {
			...
			case STRING:
				enterOuterAlt(_localctx, 1);
				{
				setState(552); ((Multi_line_stringContext)_localctx).s = match(STRING);
			...
			case MULTI_LINE_STRING:
				enterOuterAlt(_localctx, 2);
				{
				setState(554); ((Multi_line_stringContext)_localctx).s = match(MULTI_LINE_STRING);
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 13: return or_expr_sempred((Or_exprContext)_localctx, predIndex);
		case 14: return and_expr_sempred((And_exprContext)_localctx, predIndex);
		case 15: return eq_neq_expr_sempred((Eq_neq_exprContext)_localctx, predIndex);
		case 16: return inequality_expr_sempred((Inequality_exprContext)_localctx, predIndex);
		case 17: return sum_expr_sempred((Sum_exprContext)_localctx, predIndex);
		case 18: return mult_expr_sempred((Mult_exprContext)_localctx, predIndex);
		case 20: return select_expr_sempred((Select_exprContext)_localctx, predIndex);
		}
		return true;
	}
	...
	public static final String _serializedATN =
		...
		"\36 \"$&(*,.\60\62\64\668:<>@BDFHJ\2\2\u024b\2L\3\2\2\2\4U\3\2\2\2\6W"+
		"\3\2\2\2\b`\3\2\2\2\nc\3\2\2\2\fg\3\2\2\2\16r\3\2\2\2\20\u0081\3\2\2\2"+
		"\22\u00b7\3\2\2\2\24\u00b9\3\2\2\2\26\u00e3\3\2\2\2\30\u00e5\3\2\2\2\32"+
		"\u00e8\3\2\2\2\34\u00f1\3\2\2\2\36\u00ff\3\2\2\2 \u010d\3\2\2\2\"\u0120"+
